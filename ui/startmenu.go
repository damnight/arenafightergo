...
//
//
//ar imgSrcMasks = map[UIElements]image.Rectangle{
...
//
//
//ar imgBackground *ebiten.Image
//
//ype StartMenuSc struct {
//       count int
//
//
//unc init() {
...
//unc drawNinePatches(dst *ebiten.Image, dstRect image.Rectangle, srcRect image.Rectangle) {
//       srcX := srcRect.Min.X
//       srcY := srcRect.Min.Y
//       srcW := srcRect.Dx()
//       srcH := srcRect.Dy()
...
//       		dst.DrawImage(dst.SubImage(image.Rect(sx, sy, sx+sw, sy+sh)).(*ebiten.Image), op)
//       	}
//       }
//
//
...
//
//
//unc (b *Button) Draw(dst *ebiten.Image) {
//       t := imageTypeButton
//       if b.mouseDown {
...
//
//
//unc (b *Button) SetOnPressed(f func(b *Button)) {
//       b.onPressed = f
//
